 ...
 */
public class VerticalRangeSlider extends BaseVerticalSlider<VerticalRangeSlider, VerticalRangeSlider.OnChangeListener, VerticalRangeSlider.OnSliderTouchListener> {

  private float minSeparation;
  private int separationUnit;

  public VerticalRangeSlider(@NonNull Context context) {
    this(context, null);
  }

  public VerticalRangeSlider(@NonNull Context context, @Nullable AttributeSet attrs) {
    this(context, attrs, R.attr.sliderStyle);
  }

  public VerticalRangeSlider(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
   ...
   */
  public interface OnChangeListener extends BaseOnChangeListener<VerticalRangeSlider> {
    @Override
    void onValueChange(@NonNull VerticalRangeSlider slider, float value, boolean fromUser);
  }

  /** Interface definition for a callback invoked when a slider's value is changed. */
  public interface OnSliderTouchListener extends BaseOnSliderTouchListener<VerticalRangeSlider> {
    @Override
    void onStartTrackingTouch(@NonNull VerticalRangeSlider slider);

    @Override
    void onStopTrackingTouch(@NonNull VerticalRangeSlider slider);
  }
  ...
  static class RangeSliderState extends AbsSavedState {
    ...
    public static final Creator<RangeSliderState> CREATOR =
        new Creator<RangeSliderState>() {
          @Override
